...
; Bank value in T6 - tags: -1 = Global, -2 = Stack, positive = dynamic
    LI S1, -1
    BEQ T6, S1, L_bc_192a91ec_use_global
; Spill t7 to slot 3
    ADD SC, FP, R0
    ADDI SC, SC, 15
    STORE T4, SB, SC
    LI T4, -2
    BEQ T6, T4, L_bc_192a91ec_use_stack
    ADD S2, T6, R0
    BEQ R0, R0, L_bc_192a91ec_done
L_bc_192a91ec_use_global:
    ADD S2, GP, R0
    BEQ R0, R0, L_bc_192a91ec_done
L_bc_192a91ec_use_stack:
    ADD S2, SB, R0
L_bc_192a91ec_done:
    MOVE RV0, S3
    MOVE RV1, S2
...
; Bank value in T6 - tags: -1 = Global, -2 = Stack, positive = dynamic
    LI T7, -1
    BEQ T6, T7, L_bc_ee4e5791_use_global
    LI S2, -2
    BEQ T6, S2, L_bc_ee4e5791_use_stack
    ADD S3, T6, R0
    BEQ R0, R0, L_bc_ee4e5791_done
L_bc_ee4e5791_use_global:
    ADD S3, GP, R0
    BEQ R0, R0, L_bc_ee4e5791_done
L_bc_ee4e5791_use_stack:
    ADD S3, SB, R0
L_bc_ee4e5791_done:
    MOVE RV0, T0
    MOVE RV1, S3
