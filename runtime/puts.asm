...
; LOAD: Pointer t2 has bank info: Dynamic("load_f0_op6_t2_bank_val")
    LI T4, -1
    BEQ T6, T4, L_bc_6d219905_use_global
    LI T3, -2
    BEQ T6, T3, L_bc_6d219905_use_stack
    ADD T5, T6, R0
    BEQ R0, R0, L_bc_6d219905_done
L_bc_6d219905_use_global:
    ADD T5, GP, R0
    BEQ R0, R0, L_bc_6d219905_done
L_bc_6d219905_use_stack:
    ADD T5, SB, R0
L_bc_6d219905_done:
...
; Canonicalizing fat pointer: FatPtr(FatPointer { addr: Temp(1), bank: Stack })
; LOAD: Pointer load_src_ptr_f0_op11_t4 has bank info: Stack
; LOAD: Using bank register Sb for load
; Recompute alloca t1 at FP+0
    ADD T1, FP, R0
    LOAD T0, SB, T1
...
; LOAD: Pointer t4 has bank info: Dynamic("load_f0_op14_t4_bank_val")
    LI T3, -1
    BEQ T7, T3, L_bc_410f36fd_use_global
    LI T2, -2
    BEQ T7, T2, L_bc_410f36fd_use_stack
    ADD T4, T7, R0
    BEQ R0, R0, L_bc_410f36fd_done
L_bc_410f36fd_use_global:
    ADD T4, GP, R0
    BEQ R0, R0, L_bc_410f36fd_done
L_bc_410f36fd_use_stack:
    ADD T4, SB, R0
L_bc_410f36fd_done:
...
; Spill t2 to slot 1
    ...
    ADDI SC, SC, 11
    STORE S0, SB, SC
; Spill load_f0_op6_t2_bank_val to slot 2
    ADD SC, FP, R0
    ADDI SC, SC, 12
    STORE T6, SB, SC
; Spill load_f0_op6_t2_bank_val to slot 3
    ADD SC, FP, R0
    ADDI SC, SC, 13
    STORE T6, SB, SC
; Spill load_f0_op7_t3_resolved_bank_0_f0_op8 to slot 4
    ADD SC, FP, R0
    ADDI SC, SC, 14
    STORE T5, SB, SC
; Spill t4 to slot 5
    ...
    ADDI SC, SC, 15
    STORE T0, SB, SC
; Spill load_f0_op14_t4_bank_val to slot 6
    ADD SC, FP, R0
    ADDI SC, SC, 16
    STORE T7, SB, SC
; Spill load_f0_op14_t4_bank_val to slot 7
    ADD SC, FP, R0
    ADDI SC, SC, 17
    STORE T7, SB, SC
; Spill load_f0_op15_t5_resolved_bank_0_f0_op16 to slot 8
    ADD SC, FP, R0
    ADDI SC, SC, 18
    STORE T4, SB, SC
; Spill t5 to slot 9
...
; Canonicalizing fat pointer: FatPtr(FatPointer { addr: Temp(1), bank: Stack })
; LOAD: Pointer load_src_ptr_f0_op19_t6 has bank info: Stack
; LOAD: Using bank register Sb for load
; Recompute alloca t1 at FP+0
    ADD S2, FP, R0
    LOAD T3, SB, S2
...
; GEP: Setting bank info for t7 to Dynamic("load_f0_op22_t6_bank_val")
; Store fat ptr to stack alloca t1 at FP+0
    ADDI SC, FP, 0
    STORE S0, SB, SC
    ADDI SC, SC, 1
...
; Spill t6 to slot 10
    ...
    ADDI SC, SC, 20
    STORE T3, SB, SC
; Spill load_f0_op22_t6_bank_val to slot 11
    ADD SC, FP, R0
    ADDI SC, SC, 21
    STORE S3, SB, SC
; Spill t7 to slot 12
    ...
    ADDI SC, SC, 22
    STORE S0, SB, SC
; Spill load_f0_op22_t6_bank_val to slot 13
    ADD SC, FP, R0
    ADDI SC, SC, 23
    STORE S3, SB, SC
; Spill load_f0_op22_t6_bank_val to slot 14
    ADD SC, FP, R0
    ADDI SC, SC, 24
    STORE S3, SB, SC
